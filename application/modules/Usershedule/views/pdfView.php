                ...
                <tr>
                  <td style="padding:50px 32px 15px 32px;border:1px solid #FFFFFF">
                    ...
                    <table width="60%" align="center" cellspacing="0" cellpadding="0" style="border:1px solid #FFFFFF;font-size: 11px;padding: 15px;border-top:0px solid #FFFFFF" >
                      <tbody>
                        <tr>
                          <td  style="padding:5px;margin:0;color:#FFFFFF;text-align:center;font-family: 'Montserrat', sans-serif;line-height: 9px;height: auto; font-size: 10px;">
                    ...
                    <table width="98%" align="center" cellspacing="0" cellpadding="0" style="border:1px solid #FFFFFF;font-size: 11px;padding: 0px;" >
                      <tbody>
                        <tr>
                          ...
                          <td valign="middle" style="padding: 15px;margin:0;color:#FFFFFF;text-align:center;font-family: 'Montserrat', sans-serif;line-height: 15px;font-size:10px;font-weight: bold; text-align: left;">
