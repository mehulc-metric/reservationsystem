...
<div class="setup-content" id="step-5">
    <div class="row text-center">
		...
		<?php if(is_array($qrcodeInfo)){
				foreach($qrcodeInfo as $qrDetails){
					if($qrDetails['status']) {
						$downloadLink = base_url('/uploads/pdf/').$qrDetails['pdf'];
						$QRCodeLink = base_url('/uploads/qr_codes/').$qrDetails['qrcode'];
		?>
		...
		<!-- <div class="info-box">
			...
			<p class="desc m-t-10">Al entrar al recinto deberá mostrar el DNI o una factura física que se correspondan con el código postal inscrito</p>
			<p class="desc">Si ha marcado la casilla de Família Numerosa deberá mostrar el carnet que lo acredita en el acceso al recinto</p>
			<p class="desc">Deberá poder acreditar que todos los asistentes son mayores de 13 años en el acceso al recinto</p>
		</div> -->
		<div class="info-box">
      <div class="info-icon"></div>
