<div class="section">
    ...
    <div class="stepwizard">
        <div class="stepwizard-row setup-panel">
            <div class="stepwizard-step">
                <a href="#step-1" type="button" class="btn btn-primary btn-default btn-circle bt1" disabled="disabled"></a>            
            </div>
            <div class="stepwizard-step">
            ...
            <div class="stepwizard-step">
                <a href="#step-5" type="button" class="btn btn-default btn-circle bt5" disabled="disabled"></a>
                <!-- <p>Step 5</p> -->
            </div>
        </div>
    </div>
    ...
    <div class="setup-content" id="step-1">    
        <form id="userform1" data-parsley-validate method="post">
            ...
            <div class="form-group m-t-xs-30 m-t-sm-15">
...
<script>
	var terms_cond_error_msg = "<?php echo lang('error_msg_select_terms_condition');?>"; //
	var select_no_of_people_msg = "<?php echo lang('plese_select_no_of_people');?>";
	var date_already_full_msg = "<?php echo lang('date_already_full');?>";
	var valid_date_select_msg = "<?php echo lang('please_select_validate_date');?>"; //
	var date_select_msg = "<?php echo lang('please_select_date');?>"; 
	var hour_already_full_msg = "<?php echo lang('hour_already_full');?>"; 
	var no_time_slot_available_msg = "<?php echo lang('no_time_slot_available');?>"; //
	var please_select_hour_msg = "<?php echo lang('please_select_hour');?>"; 
	var payment_btn_click_msg = "<?php echo lang('payment_btn_click');?>"; //
	var please_wait_msg = "<?php echo lang('please_wait');?>";
	var email_has_been_used_msg = "<?php echo lang('email_has_been_used');?>"; //
	var alert_title_msg = "<?php echo lang('alert');?>"; 
</script>
