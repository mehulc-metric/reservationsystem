        ...
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">
                    <?php echo ($screenType == 'edit') ? lang('view_cancelled_reservation_details') : ''; ?>
                </h1>
            </div>
        </div>
        <?php
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
                               <?php echo lang("cancelled_reservation_information"); ?>
                            </a>
                        </div>
                        <div id="collapseOne" class="panel-collapse collapse in">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="control-label col-sm-4 required"><?php echo lang("reserved_date"); ?>:</label>
                                        <div class="col-sm-8">
                                            <?php if ($reserved_date != "") { ?>
                                                <p class="form-control-static" ><?php echo $reserved_date; ?></p>
                                            <?php } else { ?>
                                                <p><?php echo " "; ?></p>
                                            <?php } ?>                           
                                        </div>
                                 ...
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="control-label col-sm-4 required"><?php echo lang("refund_id"); ?>:</label>
                                        <div class="col-sm-8">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="control-label col-sm-4 required"><?php echo lang("refund_amount"); ?>:</label>
                                        <div class="col-sm-8">
